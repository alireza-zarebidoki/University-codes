...
در شکل \ref{fig:single_dragon}، منحنی اژدها تا مرحله ۱۱ با استفاده از بسته تیکز\footnote{\lr{TikZ}} ترسیم شده است. استفاده از گرادینت رنگی در رسم نشان می‌دهد که مسیر از کجا شروع شده و به کجا ختم می‌شود (از آبی تیره به سمت روشن). این تکنیک بصری ثابت می‌کند که منحنی هرگز خود را قطع نمی‌کند، بلکه صرفاً رئوس خود را لمس می‌کند.
